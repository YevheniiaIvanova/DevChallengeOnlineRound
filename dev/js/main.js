...
document.addEventListener('DOMContentLoaded', function () {
  var changeThemeButton = document.querySelector('.fn_change_theme');
  var playVideoButton = document.querySelector('.fn_play_video');
  var video = document.querySelector('.video');
  var sliderCursor = document.querySelector('[data-slider-cursor]');
  ...
  var slider = new _glidejs_glide__WEBPACK_IMPORTED_MODULE_1__["default"]('.glide', config).mount();
